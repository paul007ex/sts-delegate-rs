...
- Native PQC signing/JWKS/downstream verification is implemented only behind the explicit OpenSSL-backed `pqc-openssl-unstable` feature; classical RS256 remains the default (#19/#29).
